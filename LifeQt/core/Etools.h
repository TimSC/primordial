...
public:
	...
	{  
        pRect->setLeft(m_left);
        pRect->setRight(m_right);
        pRect->setTop(m_top);
        pRect->setBottom(m_bottom);
	}
...
public:
	// Constructors
    BRectItem(QRect* pRect) : BRect(pRect), m_indexLeft(-1),
...
class CLine
{
  public:
    ...
    CLine(const QPoint& p1, const QPoint& p2)
	{
